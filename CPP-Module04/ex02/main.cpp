...
int main()
{
    std::cout << BOLD << CYAN << "\n=== Demonstrating Abstract Class ===" << RESET << std::endl;
    std::cout << YELLOW << "Note: Animal cannot be instantiated directly!" << RESET << std::endl;
    std::cout << YELLOW << "Uncommenting the line below would cause a compilation error:" << RESET << std::endl;
    std::cout << MAGENTA << "// Animal* generic = new Animal(); // ERROR: cannot instantiate abstract class" << RESET << std::endl;
